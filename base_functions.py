...
import numpy as np
import sys
from fns import load_cifar10_dataset, load_mnist_dataset, load_fashionmnist, find_average, get_frequency_components_dataset, load_stanford40_dataset, load_sentiment_dataset
...
def get_dataset(dataset_name, is_binarized, is_resized, is_grayscale, sentiment_mode = 'original', classification_type = 'binary'):
    if(dataset_name == "sentiment_analysis"):
        data_X, data_Y, cv_X, cv_Y, test_X, test_Y = load_sentiment_dataset(mode = sentiment_mode, classification_type = classification_type)
